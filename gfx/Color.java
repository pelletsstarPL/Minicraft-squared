...
public class Color {
	...
	*/
	...
	public static final int ORANGE = Color.get(1, 255, 165, 0);
	public static final int MAGENTA = Color.get(1, 255, 0, 255);
	public static final int CYAN = Color.get(1, 90, 204, 204);
	public static final int PINK = Color.get(1, 255, 182, 193);
	...
	public static int createShadowCol(final int col, final int intensity) {
		return createShadowCol(col, intensity, intensity, intensity);
	}

	public static int createShadowCol(final int col, final int intensity_r, final int intensity_g, final int intensity_b) {
		int r = col / 16;
		int g = (col - r * 16) / 6;
		int b = col - r * 16 - g * 6;
		r -= intensity_r;
