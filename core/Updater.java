...
public class Updater extends Game {
	...
	public static void tick() {
		...
		if(tickCount>37800 && tickCount<=57000) {
			Screen.reduce = ((tickCount - 37800) / 25 < 0 ? 0 : (tickCount - 37800) / 25);
		}else if(tickCount>57000){
			Screen.reduce=((tickCount - 37800) / 255 < 0 ? 0 : (tickCount - 37800) / 280)-((tickCount-57000)/100);
			if(Screen.reduce<0)Screen.reduce=0;
		}
		if(tickCount==2000) {
			if (isbloody == false) {
