...
public class Game {
	...
	public static final String NAME = "Minicraft²"; // This is the name on the application window.
	public static final Version VERSION = new Version(TitleDisplay.version);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (Network.autoclient)
			...
			setMenu(new SkinDisplay()); // Sets menu to the title screen
		}
