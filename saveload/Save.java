...
public class Save {
	...
	public static boolean AirWizard2Beaten = false;
	File folder;
	...
	private void writeGame(String filename) {
		...
		data.add(String.valueOf(AirWizard2Beaten)); //for t2
		data.add(String.valueOf(NightWizard.beaten));
		data.add(String.valueOf(Updater.isbloody));
		data.add(String.valueOf(Updater.additionalChance));
		data.add(String.valueOf(SandTile.hotdayobtained));
		data.add(String.valueOf(NightWizard.revenge));
