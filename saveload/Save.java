...
public class Save {
	...
	private void writeGame(String filename) {
		...
		data.add(String.valueOf(AirWizardPhase4.beaten));
	...
	public static void writePlayer(Player player, List<String> data) {
		...
		data.add(String.valueOf(AirWizard.invulnerability));
	...
	public static String writeEntity(Entity e, boolean isLocalSave) {
		...
		if (!isLocalSave) {
			...
			if (e instanceof Spark2) extradata.append(":").append(((Spark) e).getData());
			if (e instanceof Spark3) extradata.append(":").append(((Spark) e).getData());
			if (e instanceof Spark4) extradata.append(":").append(((Spark) e).getData());
			if (e instanceof Spark5) extradata.append(":").append(((Spark) e).getData());
