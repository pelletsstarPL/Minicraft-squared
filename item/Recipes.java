...
public class Recipes {
	...
	static {
		...
		workbenchRecipes.add(new Recipe("Obsidian Brick_2", "Obsidian_6"));
		...
		workbenchRecipes.add(new Recipe("Wood Sword_1", "Wood_6","Stick_3"));
		workbenchRecipes.add(new Recipe("Wood Axe_1", "Wood_6","Stick_3"));
		workbenchRecipes.add(new Recipe("Wood Hoe_1", "Wood_6","Stick_3"));
		workbenchRecipes.add(new Recipe("Wood Pickaxe_1", "Wood_6","Stick_3"));
		workbenchRecipes.add(new Recipe("Wood Shovel_1", "Wood_6","Stick_3"));
		workbenchRecipes.add(new Recipe("Wood Bow_1", "Wood_6","Stick_3","string_2"));
		workbenchRecipes.add(new Recipe("Rock Sword_1", "Wood_5","Stick_3","Stone_5"));
		workbenchRecipes.add(new Recipe("Rock Axe_1", "Wood_5","Stick_3","Stone_5"));
		workbenchRecipes.add(new Recipe("Rock Hoe_1", "Wood_5","Stick_3","Stone_5"));
		workbenchRecipes.add(new Recipe("Rock Pickaxe_1", "Wood_5","Stick_3","Stone_5"));
		workbenchRecipes.add(new Recipe("Rock Shovel_1", "Wood_5","Stick_3","Stone_5"));
		workbenchRecipes.add(new Recipe("Rock Bow_1", "Stick_5","Stone_6", "string_2"));
