...
public class TileItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new TileItem("Rose", (new Sprite(5, 0, 0)), "rose", "grass"));
		items.add(new TileItem("Azalea", (new Sprite(5, 2, 0)), "azalea", "moss"));
		items.add(new TileItem("Small rose", (new Sprite(5, 1, 0)), "small rose", "grass"));
		items.add(new TileItem("Small flower", (new Sprite(4, 2, 0)), "small flower", "grass"));
		items.add(new TileItem("Sunflower", (new Sprite(4, 1, 0)), "sunflower", "grass"));
		items.add(new TileItem("Acorn", (new Sprite(7, 3, 0)), "tree Sapling", "grass"));
		items.add(new TileItem("Catkin", (new Sprite(13, 3, 0)), "birch Sapling", "grass"));
		...
		items.add(new TileItem("MossT", (new Sprite(17, 3, 0)), "moss", "dirt"));
