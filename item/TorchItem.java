...
public class TorchItem extends TileItem {
	...
	private TorchItem(int count) {
		super("Torch", (new Sprite(11, 3, 0)), count, "", "dirt", "Wood Planks", "Stone Bricks", "Obsidian", "Wool", "Red Wool", "Blue Wool", "Green Wool", "Yellow Wool", "Black Wool", "grass", "sand","Raw Obsidian");
	}
