...
public class TorchItem extends TileItem {
	...
	private TorchItem(int count) {
		super("Torch", (new Sprite(11, 3, 0)), count, "", "dirt", "Wood Planks", "Stone Bricks", "Obsidian", "Wool", "Red Wool", "Blue Wool", "Green Wool", "Yellow Wool", "Black Wool", "Light Blue Wool", "Orange Wool", "Purple Wool", "Magenta Wool","Lime Wool","Cyan Wool","Gray Wool","Pink Wool","Light Gray Wool","grass", "sand","Raw Obsidian","Skygrass","Moss","Snow","Coarse Dirt","Ornate stone","Ornate obsidian","Rocky stone","Decorated obsidian","Ground rock","path");
	}
