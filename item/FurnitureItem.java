...
public class FurnitureItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new FurnitureItem(new Spawner(new Wraith(1))));
		...
		items.add(new FurnitureItem(new Spawner(new KnightTop())));
		items.add(new FurnitureItem(new Spawner(new KnightTopT())));
		items.add(new FurnitureItem(new Spawner(new AncSkeleton())));
		items.add(new FurnitureItem(new Spawner(new Clallay())));
