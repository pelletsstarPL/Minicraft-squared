...
public abstract class Tile {
	...
	public boolean connectsToGroundDeepslate = false;
	...
	protected Tile(String name, Sprite sprite,boolean canburn,int burning,int isBurning) {
		this.name = name.toUpperCase();
		this.sprite = sprite;
		this.burning=0;
		this.canburn=false;
	...
	protected Tile(String name, ConnectorSprite sprite,boolean canburn,int burning,int isBurning) {
		this.name = name.toUpperCase();
		csprite = sprite;
		this.burning=0;
		this.canburn=false;
	...
	public boolean flammable() { return false; }
