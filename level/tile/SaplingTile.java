...
public class SaplingTile extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		switch(growsTo.id) {
			case 8:sprite.render(screen, x * 16, y * 16);break;
			case 53:spriteBirch.render(screen, x * 16, y * 16);break;
			case 11:spriteCactus.render(screen, x * 16, y * 16);break;
			case 89: case 87:spriteConifer.render(screen, x * 16, y * 16);break;
			case 25:spriteCloud.render(screen, x * 16, y * 16);break;
		}
	}
