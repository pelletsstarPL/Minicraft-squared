...
public class WoolTile extends Tile {
	...
	public enum WoolType {
		...
		GREEN("Green Wool", new Sprite(34, 2, 2, 2, 1)),
		LIME("Lime Wool", new Sprite(10, 2, 2, 2, 1)),
		NORMAL("Wool", new Sprite(8, 0, 2, 2, 1)),
		RED("Red Wool", new Sprite(10, 0, 2, 2, 1)),
		YELLOW("Yellow Wool", new Sprite(8, 4, 2, 2, 1)),
		ORANGE("Orange Wool", new Sprite(32, 4, 2, 2, 1)),
		MAGENTA("Magenta Wool", new Sprite(34, 4, 2, 2, 1)),
		PURPLE("Purple Wool", new Sprite(36, 4, 2, 2, 1)),
		LBLUE("Light Blue Wool", new Sprite(32, 2, 2, 2, 1)),
		CYAN("Cyan Wool", new Sprite(36, 2, 2, 2, 1)),
		LGRAY("Light Gray Wool", new Sprite(32, 0, 2, 2, 1)),
		PINK("Pink Wool", new Sprite(34, 0, 2, 2, 1)),
		GRAY("Gray Wool", new Sprite(36, 0, 2, 2, 1));
