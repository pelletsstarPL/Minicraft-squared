...
public final class Tiles {
	...
	public static void initTileList() {
		...
		tiles.set(12, new SaplingCactusTile("Cactus Sapling", Tiles.get("Sand"), Tiles.get("Cactus")));
		...
		tiles.set(54, new SaplingTileBirch("birch Sapling", Tiles.get("Grass"), Tiles.get("Birch")));
