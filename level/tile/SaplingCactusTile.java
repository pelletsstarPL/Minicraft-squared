...
public class SaplingCactusTile extends Tile {
	private static Sprite sprite = new Sprite(11, 7, 1);
	
	private Tile onType;
	private Tile growsTo;
	
	protected SaplingCactusTile(String name, Tile onType, Tile growsTo) {
		super(name, sprite);
		this.onType = onType;
