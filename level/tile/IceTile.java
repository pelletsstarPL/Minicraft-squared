...
public class IceTile extends Tile {
	...
	public void steppedOn(Level level, int x, int y, Entity entity) {
		...
		if (entity instanceof Mob && (!(entity instanceof AirWizard) && !(entity instanceof AirWizardPhase2) && !(entity instanceof AirWizardPhase3) && !(entity instanceof AirWizardPhase4) && !(entity instanceof AirWizardPhase5) && !(entity instanceof Ghost) && !(entity instanceof Wraith) && !(entity instanceof WraithA) && !(entity instanceof Clallay))) {
