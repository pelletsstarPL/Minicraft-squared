...
public class SaplingTileBirch extends Tile {
	private static Sprite sprite = new Sprite(11, 8, 1);
	
	private Tile onType;
	private Tile growsTo;
	
	protected SaplingTileBirch(String name, Tile onType, Tile growsTo) {
		super(name, sprite);
		this.onType = onType;
