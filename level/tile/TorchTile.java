...
public class TorchTile extends Tile {
	...
	private static ConnectorSprite spriteG =new ConnectorSprite(RockTileG.class, new Sprite(18, 6, 3, 3, 1, 3), new Sprite(21, 8, 2, 2, 1, 3), new Sprite(21, 6, 2, 2, 1, 3));
	...
	private TorchTile(Tile onType) {
		...
		this.connectsToMoss = onType.connectsToMoss;
		this.connectsToSnow = onType.connectsToSnow;
		this.connectsToGroundRock= onType.connectsToGroundRock;
	}
