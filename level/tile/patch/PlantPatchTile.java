...
public class PlantPatchTile extends Tile {
    ...
    public enum PlantPatchType {
        CloudCactus(10,"Cloud",new Sprite(54, 0,2,2,1),new String[] {"Cloud shard","Cloud cactus"},new Integer[] {0,0}, new Integer[]{4,3}),
        Cactus(10,"Sand",new Sprite(54, 2,2,2,1),new String[] {"Cactus"},new Integer[]{2},new Integer[]{4}),
        ...
        Fungus(15,"Moss",new Sprite(54, 4,2,2,1),new String[] {"Fungus spores"},new Integer[] {2}, new Integer[]{4});
