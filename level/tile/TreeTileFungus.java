...
public class TreeTileFungus extends Tile {
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		if (u && ul && l) {
			screen.render(x * 16 + 0, y * 16 + 0, 6 + 10 * 32, 0, 1);
		} else {
			screen.render(x * 16 + 0, y * 16 + 0, 5 + 18 * 32, 0, 1);
		}
		if (u && ur && r) {
			screen.render(x * 16 + 8, y * 16 + 0, 6 + 11 * 32, 0, 1);
		} else {
			screen.render(x * 16 + 8, y * 16 + 0, 6 + 18 * 32, 0, 1);
		}
		if (d && dl && l) {
			screen.render(x * 16 + 0, y * 16 + 8, 6 + 11 * 32, 0, 1);
		} else {
			screen.render(x * 16 + 0, y * 16 + 8, 5 + 19 * 32, 0, 1);
		}
		if (d && dr && r) {
			screen.render(x * 16 + 8, y * 16 + 8, 6 + 10 * 32, 0, 1);
		} else {
