...
public class LavaTile extends Tile {
	...
	public boolean tick(Level level, int xt, int yt) {
		...
		if (level.getTile(xn, yn) != Tiles.get("hole") &&(level.getTile(xn, yn).name.contains("PLANK")  || level.getTile(xn, yn).name.contains("WOOD") || level.getTile(xn, yn).name.contains("WOOL")) || level.getTile(xn, yn) == Tiles.get("MangroveWater") || level.getTile(xn, yn) == Tiles.get("lily pad")) {
