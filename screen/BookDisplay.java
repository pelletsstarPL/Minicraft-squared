...
public class BookDisplay extends Display {
	...
	private static String demonicolon = "\0"+"Why are you bothering yourself with meaning of those numbers?"+
			"\nThere is no point of looking for deeper meanings, no point seeking secrets in this book,\n"+System.getProperty("user.name")+
			". \n Summon demonical wizards using this book.";
	...
	//public BookDisplay(String book, boolean hasTitle, boolean hideCountIfOnePage) {
		...
		if (book == null) {
			book = defaultBook;
			hasTitle = false;
		}else if(book == BookData.demonicolon){
			book = BookData.demonicolon+demonicolon;
					hasTitle=true;
		}
