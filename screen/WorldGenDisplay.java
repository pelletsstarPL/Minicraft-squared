				...
				new SelectEntry("Create World", () -> {
					...
					public void render(Screen screen, int x, int y, boolean isSelected) {
						...
						if((int)Settings.get("size")>=512) {
							Font.drawCentered("This world may be laggy on old", screen, Screen.h - 16, Color.RED);
							Font.drawCentered("and low-level devices", screen , Screen.h - 8, Color.RED);
						}
					}
				},
				
				Settings.getEntry("size"),
				//	new StringEntry((Settings.getIdx("size")==256) ? "This world may be very laggy" : "",Color.RED),
				//	new StringEntry("on low-quality devices",Color.RED),
					//((Settings.get("size")=="128") ?  new StringEntry("This world may be very laggy on low-quality computers/devices",Color.RED) : new BlankEntry()),
