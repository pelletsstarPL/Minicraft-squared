...
public class CraftingDisplay extends Display {
	...
	public CraftingDisplay(List<Recipe> recipes, String title, Player player, boolean isPersonal) {
		...
		itemCountMenu = new Menu.Builder(true, 0, RelPos.LEFT,21)
		...
		costsMenu = new Menu.Builder(true, 0, RelPos.LEFT,22)
	...
	public void render(final Screen screen) {
		...
		Font.draw(text, screen, 144 - text.length(), 112, Color.WHITE);
	}
}
