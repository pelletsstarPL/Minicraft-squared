...
public class Spark5 extends Entity {
	...
	private final AirWizardPhase5 owner; // The AirWizard that created this spark
	 ...
	 * @param ya Y velocity.
	 */
	public Spark5(AirWizardPhase5 owner, double xa, double ya) {
		super(0, 0);
