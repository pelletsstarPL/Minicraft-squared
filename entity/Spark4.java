...
public class Spark4 extends Entity {
	private int lifeTime; // How much time until the spark disappears
	private double xa, ya,xa2,ya2; // The x and y acceleration
	private double xx, yy; // The x and y positions
	private int time; // The amount of time that has passed
	private final AirWizardPhase4 owner; // The AirWizard that created this spark
	 ...
	 * @param ya Y velocity.
	 */
	public Spark4(AirWizardPhase4 owner, double xa, double ya) {
		super(0, 0);
