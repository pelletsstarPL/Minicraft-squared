...
public class KnightTop extends EnemyOneTierMob {
	private static MobSprite[][] sprites = MobSprite.compileMobSpriteAnimations(24, 0);
	...
	protected void touchedBy(Entity entity) { // If an entity (like the player) touches the enemy mob
		...
		if(entity instanceof Player) {
			((Player)entity).hurt(this, 2 * (Settings.get("diff").equals("Hard") ? 2 : 1));
		}
	}
	@Override
	public void tick() {
