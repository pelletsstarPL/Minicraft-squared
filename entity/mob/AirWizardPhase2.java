...
public class AirWizardPhase2 extends EnemyMob {
	...
	static {
		...
		// normal sprite
		for (int i = 0; i < 2; i++) {
			MobSprite[][] list = MobSprite.compileMobSpriteAnimations(8, 16 + (i * 2));
			sprites[i] = list;
			invulnerableSprite = MobSprite.compileMobSpriteAnimations(0, 16+ (i*2));
		}
